  ...
  return (
    <div className="flex items-center gap-2.5">
      ...
      <select
        ...
        className="appearance-none bg-white/5 border border-[var(--color-border-subtle)] text-[var(--color-text-primary)] text-sm font-semibold rounded-xl px-4 py-2 pr-9 focus:ring-2 focus:ring-amber-500/30 focus:border-amber-500/50 outline-none transition-all cursor-pointer hover:bg-white/10"
        style={{
